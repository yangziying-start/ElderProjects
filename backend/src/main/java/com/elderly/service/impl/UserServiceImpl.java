...
//        }
        ...
        if (existUser != null) {
            throw new RuntimeException("该手机号已注册，请直接登录或联系管理员");
        }
    ...
    public String adminLogin(String username, String password) {
        ...
        if (admin == null) {
            ...
            if ("admin".equals(username) && "admin123".equals(password)) {
                ...
                save(admin);
                // 记录首次创建并登录日志
                adminLogService.log(admin.getId(), admin.getName(), "系统登录", "首次创建超级管理员并登录");
        ...
        // 记录管理员登录日志
        String roleDesc = admin.getAdminRole() == 1 ? "超级管理员" : "普通管理员";
        adminLogService.log(admin.getId(), admin.getName(), "系统登录", roleDesc + "登录系统");
