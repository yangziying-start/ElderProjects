...
public class FamilyController {
    ...
    public Result<Void> unbindElderly(@RequestAttribute Long userId, @RequestBody Map<String, Long> body) {
        ...
        if (currentUser.getFamilyId() == null || elderly == null || 
                !currentUser.getFamilyId().equals(elderly.getFamilyId())) {
            throw new RuntimeException("该老人未与您绑定");
        }
        
        // 将老人从家庭中移除
        elderly.setFamilyId(null);
        userService.updateById(elderly);
