...
public class FamilyController {
    ...
    @Log(module = "用户管理", operationType = 2, desc = "'绑定紧急联系人, 老人ID: ' + #body['elderlyId'] + ' 联系人手机/身份证: ' + (#body['contactPhone']!=null?#body['contactPhone']:#body['contactIdCard'])")
    ...
    @Log(module = "用户管理", operationType = 2, desc = "'解绑紧急联系人, 老人ID: ' + #body['elderlyId'] + ' 联系人ID: ' + #body['contactId']")
    public Result<Void> adminUnbindContact(@RequestBody Map<String, Object> body) {
        ...
        // 将子女从家庭中移除 - 使用 LambdaUpdateWrapper 强制更新 null 值
        userService.update(new com.baomidou.mybatisplus.core.conditions.update.LambdaUpdateWrapper<User>()
                .eq(User::getId, contactId)
                .set(User::getFamilyId, null)
                .set(User::getRelatedIdCard, null));
