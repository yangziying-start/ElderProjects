...
public class MealController {
    ...
    @PostMapping("/order")
    public Result<Map<String, Object>> createOrder(@RequestBody MealBookingRequest request,
    ...
    public Result<Boolean> confirmOrder(@PathVariable Long id,
                                        @RequestHeader("Authorization") String token) {
        Long userId = jwtUtil.getUserId(token.replace("Bearer ", ""));
        return Result.success(mealService.confirmOrder(id, userId));
    }
    ...
    public Result<Boolean> disputeOrder(@PathVariable Long id,
                                        @RequestParam String reason,
                                        @RequestHeader("Authorization") String token) {
        Long userId = jwtUtil.getUserId(token.replace("Bearer ", ""));
        return Result.success(mealService.disputeOrder(id, userId, reason));
    }
}
