<template>
  <view class="container">
    ...
    <view class="tab-bar">
      ...
      <view class="tab-item" @click="goPage('/pages-child/user/index')">
        <text class="tab-icon">👤</text>
...
const goHealthRecord = () => {
  ...
  uni.navigateTo({ url: `/pages-child/care/health?elderlyId=${selectedElderly.value.id}` })
}
...
const goSchedule = () => {
  ...
  uni.navigateTo({ url: `/pages-child/care/schedule?elderlyId=${selectedElderly.value.id}` })
}
