  ...
  <view class="login-container">
    ...
    <view class="login-form" v-else>
      <view class="form-header">
        ...
        <text class="form-title">{{ roleNames[selectedRole] }}{{ isRegister ? '注册' : '登录' }}</text>
      </view>
      ...
      <view class="login-btn" @click="doSubmit">{{ isRegister ? '注册' : '登录' }}</view>
      
      <view class="switch-mode" @click="isRegister = !isRegister">
        <text>{{ isRegister ? '已有账号？去登录' : '没有账号？去注册' }}</text>
      </view>
      
      <view class="password-tip" v-if="!isRegister">
